  ...
  return(
    <div className="w-screen h-screen flex-col  bg-[url('./images/bg-2.png')]  flex">
      ...
      <div className="mt-auto p-4 text-center text-white text-sm">
                Developed and Designed By <a className="text-[#2AB7B1] hover:text-[#1e8682] transition-colors duration-300" href="/" target="_blank" rel="noopener noreferrer">Mohit, Manpreet & Pravhjot</a>
              </div>
